...
srun --output=%JOB_LOGS_PATH%/output_%t.log --error=%JOB_LOGS_PATH%/error.log singularity exec --nv /gpfs/projects/bsc88/singularity-images/fastchat-pytorch.sif bash <<EOF
